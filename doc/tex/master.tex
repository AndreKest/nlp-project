...
\usepackage{makeidx}			% Begriffsindex erstellen
\usepackage{float}
\makeindex
...
% 
\newcommand*{\IhrVorname}{}
\newcommand*{\IhrNachname}{Kestler, Kohl, Prettner}
\newcommand*{\IhrStudiengang}{Künstliche Intelligenz}
\newcommand*{\IhreArbeit}{Studienarbeit NLP}
\newcommand*{\IhrTitelDE}{Wintersemester 2021}
\newcommand*{\IhrTitelEN}{}
\newcommand*{\IhrBearbeitungszeitraumVON}{24. November 2021}
\newcommand*{\IhrBearbeitungszeitraumBIS}{18. Januar 2022}
\newcommand*{\IhrErstpruefer}{Prof. Dr.-Ing. Ulrich Schäfer}
...
\newcommand*{\IhreSchluesselwoerter}{NLP}
...
% %----------------------------------------------------------------------  
  ...
  %	StMWK  & Staatsministerium für Wissenschaft und Kunst\\
  %\end{tabular}
  %\newpage
  %
% %----------------------------------------------------------------------  
  ...
  %  \begin{tabular}{ll}
  %\end{tabular}
  %  bzw. Glossar ... fehlt noch komplett. Ist nicht in der Vorlage.
  %  Gehört das zusammen mit dem Abkürzungsverzeichnis?
  %\newpage
...
%  %Begriffsverzeichnis
%  \phantomsection
%  %\renewcommand{\index}{Begriffsverzeichnis} %Umbenennen
%  \addcontentsline{toc}{chapter}{Index} %Fügt zum Inhaltsverzeichnis hinzu
%  \printindex
%  \newpage
